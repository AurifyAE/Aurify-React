...
const UserList = () => {
  ...
  const handleAddUser = async (userData) => {
    try {
      ...
      setShowNotification(true);
      setNotificationMessage("Error adding user: " + (error.response?.data?.message || error.message));
    }
  };
  ...
  const handleEditUser = async (userId, updatedUserData) => {
    try {
      ...
      setShowNotification(true);
      setNotificationMessage("Error updating user: " + (error.response?.data?.message || error.message));
    }
  };
